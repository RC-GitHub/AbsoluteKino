...
export const MOVIE_ERR_TYPING: string = "Movie title, viewing format, duration, description, poster and trailer url, language, premiere date, genre, restrictions, cast and directors should have correct typings (all should be of type string besides viewing format, which should be an integer)";
...
export const MOVIE_ERR_VIEWING_FORMAT: string = `Movie viewing format length is incorrect (it should be between ${Constants.MOVIE_VF_MIN_LEN} and ${Constants.MOVIE_VF_MAX_LEN})`;
...
export const MOVIE_ERR_RESTRICTIONS: string = `Movie age restrictions length is incorrect (it should be between ${Constants.MOVIE_AR_MIN_LEN} and ${Constants.MOVIE_AR_MAX_LEN})`;
...
export const MOVIE_ERR_DIR_LEN: string = `Movie directors length is incorrect (it should be between ${Constants.MOVIE_DIR_MIN_LEN} and ${Constants.MOVIE_DIR_MAX_LEN})`;
